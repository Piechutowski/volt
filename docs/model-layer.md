...
*The philosophy behind Volt's data layer. What nao is and how it
answers this analysis: [`nao.md`](nao.md); the per-capability audit
derived from it: [`reference/orm-matrix.md`](reference/orm-matrix.md).*
