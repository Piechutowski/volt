<!-- Ecto.Migration: extracted verbatim from lib/ecto/migration.ex (ecto_sql repo) by fetch.sh. Apache-2.0. -->
...
### `@type t :: %__MODULE__{ table: String.t(), prefix: String.t() | nil, column: atom, type: atom, on_delete: atom …`
...
## defmodule Ecto.Migration (continued)
...
### `create_if_not_exists(%Index{} = index)`
...
### `rename(%Table{} = table_current, to: %Table{} = table_new)`
...
### `rename(%Table{} = table, current_column, to: new_column)`
