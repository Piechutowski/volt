<!-- Ecto.Query: extracted verbatim from lib/ecto/query.ex (ecto repo) by fetch.sh. Apache-2.0. -->
...
### `defstruct prefix: nil, sources: nil, from: nil, joins: [], aliases: %{}, wheres: [], select: nil, order_bys: [ …`
...
### `put_query_prefix(%Ecto.Query{} = query, prefix)`
...
### `has_named_binding?(%Ecto.Query{aliases: aliases}, key)`
...
### `with_named_binding(%Ecto.Query{} = query, key, fun)`
...
### `reverse_order(%Ecto.Query{} = query)`
