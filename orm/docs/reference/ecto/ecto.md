<!-- Ecto: extracted verbatim from lib/ecto.ex (ecto repo) by fetch.sh. Apache-2.0. -->
...
## `primary_key(%{__struct__: schema} = struct)`
...
## `build_assoc(%{__struct__: schema} = struct, assoc, attributes \\ %{})`
...
## `put_meta(%{__meta__: meta} = struct, opts)`
...
## `embedded_dump(%schema{} = data, format)`
