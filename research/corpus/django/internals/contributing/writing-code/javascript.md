...
- Use the [Biome](https://biomejs.dev/) code linter to check your code for bugs and style errors. Biome will be run by the pre-commit hooks. We also recommended installing a Biome plugin in your text editor.
...
Please consult the `QUnit` documentation for information on the types of [assertions supported by QUnit](https://api.qunitjs.com/assert/).
