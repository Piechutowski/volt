...
Feature release  
Feature releases (A.B, A.B+1, etc.) will happen roughly every eight months -- see [release process](#release-process) for details. These releases will contain new features, improvements to existing features, and such.
