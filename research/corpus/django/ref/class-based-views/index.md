...
Class-based views API reference. For introductory material, see the `/topics/class-based-views/index` topic guide.

<div class="toctree" maxdepth="3">

base generic-display generic-editing generic-date-based mixins flattened-index
...
A class-based view is deployed into a URL pattern using the `~django.views.generic.base.View.as_view` classmethod:
...
Most generic views require the `queryset` key, which is a `QuerySet` instance; see `/topics/db/queries` for more information about `QuerySet` objects.
