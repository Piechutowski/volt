...
<div class="module" synopsis="Django's admin documentation generator.">
...
Django's `~django.contrib.admindocs` app pulls documentation from the docstrings of models, views, template tags, and template filters for any app in `INSTALLED_APPS` and makes that documentation available from the `Django admin <django.contrib.admin>`.

## Overview

To activate the `~django.contrib.admindocs`, you will need to do the following:
...
- Install the `docutils` 0.22+ package.
