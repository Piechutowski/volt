...
<div class="module" synopsis="A set of Django template filters useful for adding a &quot;human
touch&quot; to data.">
...
`/topics/i18n/formatting` will be respected if enabled, e.g. with the `'de'` language:
