...
- Implemented `ForeignKey.get_db_prep_value()` so that `ForeignKey`s pointing to `~django.db.models.UUIDField` and inheritance on models with `UUIDField` primary keys work correctly (`24698`, `24712`).
