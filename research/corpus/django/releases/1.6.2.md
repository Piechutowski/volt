...
- Fixed an issue where lazy objects weren't actually marked as safe when passed through `~django.utils.safestring.mark_safe` and could end up being double-escaped (`21882`).
