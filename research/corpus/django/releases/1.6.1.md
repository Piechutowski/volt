...
- Fixed `Queryset.datetimes<django.db.models.query.QuerySet.datetimes>` raising `AttributeError` in some situations (#21432).
...
- Fixed a crash in `~django.db.models.ImageField` on some platforms (Homebrew and RHEL6 reported) (#21355).
