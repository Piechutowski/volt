...
`~django.core.validators.validate_ipv4_address`, `~django.core.validators.validate_slug`, and `~django.core.validators.URLValidator` and their usage in the corresponding form fields `GenericIPAddresseField`, `IPAddressField`, `SlugField`, and `URLField` are also affected.
