...
- Fixed a regression in Django 5.2.2 where `HttpRequest.get_preferred_type() <django.http.HttpRequest.get_preferred_type>` incorrectly preferred more specific media types with a lower quality (`36447`).
