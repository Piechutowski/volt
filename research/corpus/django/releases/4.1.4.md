...
- Fixed a bug in Django 4.1 that caused a crash of the sitemap index view with an empty `Sitemap.items() <django.contrib.sitemaps.Sitemap.items>` and a callable `~django.contrib.sitemaps.Sitemap.lastmod` (`34088`).
