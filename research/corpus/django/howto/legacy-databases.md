...
If you do want to allow Django to manage the table's lifecycle, you'll need to change the `~django.db.models.Options.managed` option above to `True` (or remove it because `True` is its default value).
