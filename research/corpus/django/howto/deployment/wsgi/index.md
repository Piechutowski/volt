...
granian gunicorn uwsgi modwsgi apache-auth
...
To apply `WSGI middleware
<3333#middleware-components-that-play-both-sides>` you can wrap the application object. For instance you could add these lines at the bottom of `wsgi.py`:
