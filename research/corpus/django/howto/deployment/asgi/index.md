...
As well as WSGI, Django also supports deploying on [ASGI](https://asgi.readthedocs.io/en/latest/), the emerging Python standard for asynchronous web servers and applications.
...
daphne granian hypercorn uvicorn
