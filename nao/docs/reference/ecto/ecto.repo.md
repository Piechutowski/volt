<!-- Ecto.Repo: extracted verbatim from lib/ecto/repo.ex (ecto repo) by fetch.sh. Apache-2.0. -->
...
## `all_running(), to: Ecto.Repo.Registry`
...
## `@callback init(context :: :supervisor | :runtime, config :: Keyword.t()) :: {:ok, Keyword.t()} | :ignore`
...
## `@callback checkout((-> result), opts :: Keyword.t()) :: result`
...
## `@callback load( schema_or_map :: module | map(), data :: map() | Keyword.t() | {list, list} ) :: Ecto.Schema.t …`
...
## `@callback get(queryable :: Ecto.Queryable.t(), id :: term, opts :: Keyword.t()) :: Ecto.Schema.t() | term | ni …`
...
## `@callback get!(queryable :: Ecto.Queryable.t(), id :: term, opts :: Keyword.t()) :: Ecto.Schema.t() | term`
...
## `@callback get_by( queryable :: Ecto.Queryable.t(), clauses :: Keyword.t() | map, opts :: Keyword.t() ) :: Ecto …`
...
## `@callback get_by!( queryable :: Ecto.Queryable.t(), clauses :: Keyword.t() | map, opts :: Keyword.t() ) :: Ect …`
...
## `@callback reload( struct_or_structs :: Ecto.Schema.t() | [Ecto.Schema.t()], opts :: Keyword.t() ) :: Ecto.Sche …`
...
## `@callback aggregate( queryable :: Ecto.Queryable.t(), aggregate :: :count, opts :: Keyword.t() ) :: term | nil`
...
## `@callback aggregate( queryable :: Ecto.Queryable.t(), aggregate :: :avg | :count | :max | :min | :sum, field : …`
...
## `@callback one(queryable :: Ecto.Queryable.t(), opts :: Keyword.t()) :: Ecto.Schema.t() | term | nil`
...
## `@callback one!(queryable :: Ecto.Queryable.t(), opts :: Keyword.t()) :: Ecto.Schema.t() | term`
...
## `@callback preload(structs_or_struct_or_nil, preloads :: term, opts :: Keyword.t()) :: structs_or_struct_or_nil`
...
## `@callback prepare_query(operation, query :: Ecto.Query.t(), opts :: Keyword.t()) :: {Ecto.Query.t(), Keyword.t …`
...
## `@callback prepare_transaction(fun_or_multi :: fun | Ecto.Multi.t(), opts :: Keyword.t()) :: {fun_or_multi :: f …`
...
## `@callback all_by( queryable :: Ecto.Queryable.t(), clauses :: Keyword.t() | map, opts :: Keyword.t() ) :: [Ect …`
...
## `@callback update_all( queryable :: Ecto.Queryable.t(), updates :: Keyword.t(), opts :: Keyword.t() ) :: {non_n …`
...
## `@callback delete_all(queryable :: Ecto.Queryable.t(), opts :: Keyword.t()) :: {non_neg_integer, nil | [term]}`
...
## `@callback insert_all( schema_or_source :: binary() | {binary(), module()} | module(), entries_or_query :: [%{( …`
...
## `@callback insert( struct_or_changeset :: Ecto.Schema.t() | Ecto.Changeset.t(), opts :: Keyword.t() ) :: {:ok, …`
...
## `@callback update(changeset :: Ecto.Changeset.t(), opts :: Keyword.t()) :: {:ok, Ecto.Schema.t()} | {:error, Ec …`
...
## `@callback insert_or_update(changeset :: Ecto.Changeset.t(), opts :: Keyword.t()) :: {:ok, Ecto.Schema.t()} | { …`
...
## `@callback delete( struct_or_changeset :: Ecto.Schema.t() | Ecto.Changeset.t(), opts :: Keyword.t() ) :: {:ok, …`
...
## `@callback insert!( struct_or_changeset :: Ecto.Schema.t() | Ecto.Changeset.t(), opts :: Keyword.t() ) :: Ecto. …`
...
## `@callback delete!( struct_or_changeset :: Ecto.Schema.t() | Ecto.Changeset.t(), opts :: Keyword.t() ) :: Ecto. …`
